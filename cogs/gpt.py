...
class Gpt(commands.Cog):
    ...
    @nextcord.slash_command(name="read",description="read message history",guild_ids=[1270418744434491413,1156116900321960017])
    ...
    @nextcord.slash_command(name="clear",description="clear message history",guild_ids=[1270418744434491413,1156116900321960017])
    async def deactivate(self,interaction:Interaction):
        self.history.clear()
